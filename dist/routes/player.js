...
const playerRouter = express_1.default.Router({ mergeParams: true });
playerRouter.use(verifyUser_1.verifyUser);
playerRouter.use(verifyQuiz_1.verifyQuiz);
...
playerRouter.get("/playersParticipated", playerController.getPlayerParticipated);
